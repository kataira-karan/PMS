    ...
    <div className=' md:flex md:flex-row md:w-screen  h-screen '>
      <div class="flex min-h-full md:w-1/2 flex-col justify-center px-6 py-12 lg:px-8  ">
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form class="space-y-6" onSubmit={loginUser} method="POST">
            <div>
            ...
            <div>
              ...
              <div class="mt-2">
                <input id="password" value={user.password} onChange={(e) => setuser({ ...user, password: e.target.value })} name="password" type="password" autocomplete="current-password" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
              </div>
            </div>
      ...
      <div className='md:h-screen md:w-1/2'>
        <img className='h-screen ' src='https://images.pexels.com/photos/15793934/pexels-photo-15793934/free-photo-of-horse-in-sunlit-stable-window.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'></img>
      </div>
    </div>
  )
}
